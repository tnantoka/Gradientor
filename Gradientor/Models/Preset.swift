...
struct Preset {
    static let names = [
        ...
        NSLocalizedString("iPad 7.9-inch", comment: ""),
        NSLocalizedString("iPad 9.7-inch", comment: ""),
        NSLocalizedString("iPad 12.9-inch", comment: ""),
        NSLocalizedString("Gradientor Gallery", comment: "")
    ]
    static let sizes = [
        CGSize(width: 1500.0, height: 500.0),
        CGSize(width: 851.0, height: 315.0),
        CGSize(width: 1242.0, height: 2208.0),
        CGSize(width: 750.0, height: 1334.0),
        CGSize(width: 640.0, height: 1136.0),
        CGSize(width: 1536.0, height: 2048.0),
        CGSize(width: 1536.0, height: 2048.0),
        CGSize(width: 2048.0, height: 2732.0),
        CGSize(width: 400.0, height: 400.0)
    ]
}
